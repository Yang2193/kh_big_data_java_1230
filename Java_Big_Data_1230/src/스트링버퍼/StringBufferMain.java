...
//String : 객체 생성 필요 없음, 문자열 추가 시 계속 새로운 문자열이 만들어짐, 문자열 추가가 길어지면 성능저하.
...
public class StringBufferMain {
    public static void main(String[] args) {
        StringBuffer sb = new StringBuffer(); // StringBuilder는 Buffer랑 똑같음.
        sb.append("Hello");
        sb.append(" ");
        sb.append("Python");
        sb.insert(0, "안녕하세요^^"); //offset 부분이 위치.
        //sb.delete(1,3); // 1번 인덱스부터 3번 인덱스 미만까지 지움( 1번, 2번 인덱스만 지워짐)
