...
import java.util.Date; // 자바.유틸패키지의 Date 클래스만 가지고 오겠다는 뜻.

// Date() : 1970년 1월 1일 0시 0분 0초 에서 현재까지의 경과시간으로 시간 계산.(msec), 객체를 생성 후 사용
// SimpleDateFormat : 운영체제로부터 얻어진 시간 정보를 얻어서 우리가 원하는 포맷으로 변경해서 출력해줌.(pattern)
public class DateEx {
