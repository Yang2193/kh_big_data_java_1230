...
// 진수 표현 : 16진수, 10진수, 8진수, 2진수(비트연산)
public class TypeEx1 {
    public static void main(String[] args) {
       /* int num1 = 1, num2 = 4;
        double rst1 = num1 / num2; // 문제가 발생하는 코드
        double rst2 = (double) num1 / num2; // 명시적인 형변환과 묵시적인 형변환이 다 일어남. 컴파일러가 더 큰 데이터 형식인 실수로 변환함.
        double rst3 = 100 + 100.1;
        System.out.println(rst1);
        System.out.println(rst2);
    
        String phoneNumber = "01077239785";
        String name = "곰돌이사육사";
        String silsoo = "3.14152";

        //int number = Integer.parseInt(phoneNumber);
       // System.out.println(number);
        double num = Double.parseDouble(silsoo);
        System.out.println(num);
*/
        int var1 = 0b1010; // 2진수
        int var2 = 0267; // 8진수 
        int var3 = 399; // 10진수
        int var4 = 0xABCDEF; // 16진수
